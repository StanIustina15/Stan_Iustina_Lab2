...
namespace Stan_Iustina_Lab2.Data
{
    public class Stan_Iustina_Lab2Context : DbContext
    {
        ...
        public DbSet<Stan_Iustina_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Stan_Iustina_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Stan_Iustina_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
